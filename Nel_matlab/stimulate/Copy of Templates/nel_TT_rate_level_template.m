function [tmplt,DAL,stimulus_vals,units,errstr] = nel_TT_rate_level_template(fieldname,stimulus_vals,units)
%
...
str{2} = sprintf('Background %1.2f Tone @ %1.1f dB Attn.', p.secondary.tone.freq/1000, p.secondary.atten);
...
tmplt.tag         = 'NELrate_level_2T_tmplt';
tmplt.IO_def = IO_def;
