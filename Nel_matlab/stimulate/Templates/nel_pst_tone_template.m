function [tmplt,DAL,stimulus_vals,units,errstr] = nel_pst_tone_template(fieldname,stimulus_vals,units)
%
...
if (exist('stimulus_vals','var') == 1)
   Inloop.Name                               = 'DALinloop_general_TN_delay';  % modified by GE (07Jan2003)
...
%     stimulus_vals.Gating.tone_Delay = 0;
   Inloop.params.tone_delay                 = stimulus_vals.Gating.Tone_Delay;  % added by GE (07Jan2003)

   DAL.Inloop = Inloop;
   DAL.Gating = stimulus_vals.Gating;
   DAL.short_description   = 'PST_tone';
...
IO_def.Gating.Tone_Delay      = {0.02        'ms'    [0.02 10000]};  % added by GE (07Jan2003)
