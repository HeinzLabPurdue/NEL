function y = Qspace_inhibit(frq1, frq2, N)
...
y=y(1:end-1)/1000;%M.Sayles (2014) - previously one too many values included - outside bounds of desired output range (frq1,frq2)