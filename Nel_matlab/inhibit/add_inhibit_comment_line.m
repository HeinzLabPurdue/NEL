function [comment]=add_inhibit_comment_line(command_str)		%function to create comment line for single unit data file
...
if strcmp(command_str,'initialize'),
   ...
   h_edit        = uicontrol(h_fig,'style','edit','callback','add_tc_comment_line(''reply'');','Units','normalized','position',[.1 .2 .8 .2],'userdata',[],'FontSize',14);								
