...
#define DAQmxErrChk(functionCall) if( DAQmxFailed(error=(functionCall)) ) printf("error");else
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	DAQmxErrChk (DAQmxCreateAIVoltageChan(taskHandle,"DAQ/ai0","",DAQmx_Val_Cfg_Default,-10.0,10.0,DAQmx_Val_Volts,NULL));
	DAQmxErrChk (DAQmxCfgSampClkTiming(taskHandle,"",10000.0,DAQmx_Val_Rising,DAQmx_Val_FiniteSamps,1000));
	DAQmxErrChk (DAQmxCfgDigEdgeStartTrig(taskHandle,"/DAQ/PFI6",DAQmx_Val_Rising));
