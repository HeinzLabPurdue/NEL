...
FIG.push.run_levels_Interleaved = uicontrol(FIG.handle,'callback','FFRwav2(''update_stim'',''Interleaved'');','style','pushbutton','Units','normalized','position',[.2 .726 .1 .09],'string','Run pABR...','fontsize',12,'fontangle','normal','fontweight','normal');
FIG.push.forget_now = uicontrol(FIG.handle,'callback','FFRwav2(''forget_now'');','style','pushbutton','Units','normalized','position',[.07 .43 .125 .05],'string','Forget NOW','fontsize',12,'fontangle','normal','fontweight','normal','Userdata','');
