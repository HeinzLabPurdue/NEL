...
switch interface_type
    case 'FFRwav2'
        ...
        Stimuli = struct( ...
            ...
            'calib_dBSPLout2', nan, ... % Ouptut in dB SPL after calibration filtering 
            'NoiseType',0,... % 0 for stationary, 1 for fluctuating
            'maxSPL', 90, ...
            'STIMfile', [NelData.General.RootDir 'Nel_matlab\AEP\FFR\Signals\tone_org.wav'], ...
            'STIMfile2', [NelData.General.RootDir 'Nel_matlab\AEP\FFR\Signals\tone_org2.wav'], ...
            ...
            'fast', struct( ...
            ... %zz 17jan12
            'duration_ms', 1000, ... % 1728 for pilot
            'rftime_ms',  10, ...
            'period_ms',  2801, ... % 1801
            'XstartPlot_ms',0, ...
            'XendPlot_ms',2500, ... % 2000 for pilot, 1800 for short 
            ...
            'rftime_ms',  10, ...
            'period_ms',  3300, ... % AEH 1/27/14 750 ms 2728
            'XstartPlot_ms',0, ...
            'XendPlot_ms', 2728, ...
            'FFRlength_ms',1750), ...
            ...%'fixedPhase', 1,  ...
            ...
            'ear2', 'right' ...  % 2nd stim ear     % needs to match default in loop_plot
            );
