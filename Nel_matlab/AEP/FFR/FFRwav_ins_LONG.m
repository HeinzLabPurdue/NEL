...
switch interface_type
    case 'FFRwav'
        ...
        Stimuli = struct( ...
            ...
            'fast', struct( ...
            ... %zz 17jan12
            'duration_ms', 15000, ... % 1728 for pilot  %1300
            'rftime_ms',  10, ...  
            'period_ms',  16001, ...  %1801 
            'XstartPlot_ms',0, ... %0
            'XendPlot_ms',15000, ... % 2000 for pilot, 1800 for short   %1500
            'FFRlength_ms',15000), ... % 2000 for pilot, 1800 for short   %1500
            ...
            ...
            'slow', struct( ...
            ...% ZZ 18nov11
