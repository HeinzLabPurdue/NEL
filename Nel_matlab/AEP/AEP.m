...
if nargin < 1
    ...
    AEP_ins; %sending here to throw ABRFlag
    ...
    elseif ~RunThroughABRFlag
        ...
        addpath([NelData.General.RootDir 'Nel_matlab' filesep 'AEP\ABR']);
        ...
        RunThroughABRFlag = 0;  
        rmpath([NelData.General.RootDir 'Nel_matlab' filesep 'AEP\ABR']);
