...
if nargin < 1
   func_dir = cd([root_dir 'srcal_232\private']);
   object_dir = [root_dir 'srcal_232\object'];
   PROG = struct('name','CALrp2.m','date',date,'version','rp2 v2.0');
   ...
   %Stimuli structure is found in get_sr530_ins
   get_sr530_ins;
   %File structure EXPS is found in explist
   
   %MAKING FIGURE AND USER INTERFACE
   FIG.handle = figure('NumberTitle','off','Name','SR530 Interface','Units','normalized','Visible','off', ...
