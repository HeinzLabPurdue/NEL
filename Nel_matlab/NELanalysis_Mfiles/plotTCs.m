function [Thresh_dBSPL_ret,BF_kHz_ret,Q10_ret] = plotTCs(CALIBpic,PIClist,PLOTyes)
% FILE: plotTCs
...
for ind=1:numTCs
   ...
   Thresh_dBSPL{ind}=TCdata{ind}(find(TCdata{ind}(:,1)==BF_kHz{ind}),3);
   ...
   figure(h999)  % in case find Q10 opens new figure
