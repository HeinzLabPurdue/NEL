...
FIG.push.stop    = uicontrol(FIG.handle,'callback','calibrate(''stop'');','style','pushbutton','Enable','off','Units','normalized','position',[.44 .23 .12 .075],...
    'string','Stop','Userdata',[],'fontsize',12,'fontangle','normal','fontweight','normal');
FIG.push.close   = uicontrol(FIG.handle,'callback','calibrate(''close'');','style','pushbutton','Units','normalized','position',[.44 .05 .12 .075],'string','Close',...
    'Userdata',[],'fontsize',12,'fontangle','normal','fontweight','normal');
FIG.push.calib   = uicontrol(FIG.handle,'callback','calibrate(''calibrate'');','style','pushbutton','Interruptible','on','Units','normalized','position',[.625 .238 .25 .062],...
...
FIG.push.recall  = uicontrol(FIG.handle,'callback','calibrate(''recall'');','style','pushbutton','Units','normalized','position',[.44 .14 .12 .075],'string','Recall',...
