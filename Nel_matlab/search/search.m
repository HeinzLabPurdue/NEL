...
if nargin < 1
    ...
    statText  = cell2struct(cell(1,1),{'spike_channel'},1);   % added by GE 17Jan2003.
    popup = cell2struct(cell(1,1),{'spike_channel'},1);   % added by GE 17Jan2003.
...
elseif strcmp(command_str,'tone')
    ...
    set(FIG.radio.tonesweep,'value',0);
    set(FIG.radio.binauralbeat,'value',0);
...
elseif strcmp(command_str,'khite')
    FIG.NewStim = 3;
%     Stimuli.KHosc = 2;
    Stimuli.KHosc = 3;%modified M. Sayles 2017 to take the KH Osc from the RP1.1 ADC channel 1 instead of via the backpanel of the switchbox
...
elseif strcmp(command_str,'tone_sweep')
    FIG.NewStim = 8;
    Stimuli.KHosc = 0;
    set(FIG.fsldr.val,'string',num2str(Stimuli.freq_hz));
    set(FIG.radio.khite,'value',0);
...
elseif strcmp(command_str,'binaural_beat')
    FIG.NewStim = 9;
    Stimuli.KHosc = 0;
    set(FIG.fsldr.val,'string',num2str(Stimuli.freq_hz));
    set(FIG.radio.khite,'value',0);
