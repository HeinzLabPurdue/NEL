...
FIG.radio.noise  = uicontrol(FIG.handle,'callback','search(''noise'');','style','radio','Enable','on','Units','normalized','position',[.125 .455 .08 .03],'string','Noise','fontsize',12,'BackgroundColor','w','value',1);
FIG.radio.tone   = uicontrol(FIG.handle,'callback','search(''tone'');','style','radio','Enable','on','Units','normalized','position',[.125 .425 .08 .03],'string','Tone','fontsize',12,'BackgroundColor','w');
FIG.radio.tonesweep   = uicontrol(FIG.handle,'callback','search(''tone_sweep'');','style','radio','Enable','on','Units','normalized','position',[.125 .395 .08 .03],'string','Tone Sweep','fontsize',12,'BackgroundColor','w');
FIG.radio.binauralbeat  = uicontrol(FIG.handle,'callback','search(''binaural_beat'');','style','radio','Enable','on','Units','normalized','position',[.125 .365 .08 .03],'string','Binaural Beat','fontsize',12,'BackgroundColor','w');
FIG.radio.khite  = uicontrol(FIG.handle,'callback','search(''khite'');','style','radio','Enable','on','Units','normalized','position',[.125 .335 .08 .03],'string','KH Osc','fontsize',12,'BackgroundColor','w');
FIG.radio.fast   = uicontrol(FIG.handle,'callback','search(''fast'');','style','radio','Enable','on','Units','normalized','position',[.125 .285 .08 .03],'string','Fast','fontsize',12,'BackgroundColor','w','value',1);
FIG.radio.slow   = uicontrol(FIG.handle,'callback','search(''slow'');','style','radio','Enable','on','Units','normalized','position',[.125 .255 .08 .03],'string','Slow','fontsize',12,'BackgroundColor','w');
...
FIG.fsldr.val    = uicontrol(FIG.handle,'style','edit','Units', 'normalized','position',[.5825 .175 .06 .04],'string','noise','fontsize',12, 'callback', 'search(''slide_freq_text'');');
...
FIG.push.x1      = uicontrol(FIG.handle,'callback','search(''mult_1x'');','style','pushbutton','Enable','on','Units','normalized','position',[.5 .23 .05 .037],'string','1X','fontsize',12,'fontangle','normal','fontweight','normal','foregroundcolor',[.7 .7 .7]);
FIG.push.x10     = uicontrol(FIG.handle,'callback','search(''mult_10x'');','style','pushbutton','Enable','on','Units','normalized','position',[.585 .23 .05 .037],'string','10X','fontsize',12,'fontangle','normal','fontweight','normal','foregroundcolor',[0 0 0]);
...
FIG.radio.left   = uicontrol(FIG.handle,'callback','search(''left'');', 'style','radio','Enable','on','Units','normalized','position',[.125 .205 .08 .03],'string','Left Ear', 'fontsize',12,'BackgroundColor','w','value',0);
FIG.radio.right  = uicontrol(FIG.handle,'callback','search(''right'');','style','radio','Enable','on','Units','normalized','position',[.125 .175 .08 .03],'string','Right Ear','fontsize',12,'BackgroundColor','w','value',0);
FIG.radio.both   = uicontrol(FIG.handle,'callback','search(''both'');', 'style','radio','Enable','on','Units','normalized','position',[.125 .145 .08 .03],'string','Both Ears','fontsize',12,'BackgroundColor','w','value',1);
