...
invoke(RP1,'LoadCOF',[prog_dir '\object\FFR_wav_polIN_test.rcx']);

invoke(RP1,'SetTagVal','StmOn',FFR_Gating.duration_ms);
% invoke(RP1,'SetTagVal','StmOff',(FFR_Gating.period_ms-FFR_Gating.duration_ms));
invoke(RP1,'SetTagVal','StmOff',4*(FFR_Gating.period_ms-FFR_Gating.duration_ms));
...
invoke(RP2,'LoadCOF',[prog_dir '\object\FFR_right2_test.rcx']);
...
rc = PAset(120.0); % added by GE/MH, 17Jan2003.  To force all attens to 120
