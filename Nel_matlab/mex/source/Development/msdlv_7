...
//         DAQmxErrChk (GetTerminalNameWithDevPrefix(taskTrigger,"Ctr7Source",startTrigger));
        
//         DAQmxConnectTerms ("/Counter/PFI0", "/Counter/Ctr7ArmStartTrigger", DAQmx_Val_DoNotInvertPolarity);
        
//         DAQmxCfgDigEdgeStartTrig(taskTrigger, startTrigger, startEdge);
...
//             DAQmxErrChk (DAQmxCfgSampClkTiming(taskSpike[i],startTrigger,100000.0,DAQmx_Val_Rising,DAQmx_Val_ContSamps,100000));//Shortest possible period between spikes: 10 microS
            
            DAQmxSetCICountEdgesTerm(taskSpike[i], channelName[i], "/Counter/100kHzTimebase");
            
//             DAQmxSetArmStartTrigType(taskSpike[i],DAQmx_Val_DigEdge);
            
//             DAQmxErrChk (DAQmxCfgDigEdgeStartTrig(taskSpike[i],startTrigger,DAQmx_Val_Rising));
//             DAQmxCfgDigEdgeStartTrig (taskSpike[i], "do/StartTrigger", DAQmx_Val_Rising);
//             DAQmxConnectTerms ("/Counter/PFI0", armName[i], DAQmx_Val_DoNotInvertPolarity);
            
//             DAQmxCfgDigEdgeStartTrig(taskSpike[i], startTrigger, startEdge);
