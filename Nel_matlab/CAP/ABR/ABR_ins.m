...
switch interface_type
   ...
   case 'ABR'
% Need to update to correct parameters
		misc = struct( ... 
         'fileExtension', 'ABR' ...
          ); 
		...
		Stimuli = struct( ...
         ...
         'fast', struct( ...
                'duration_ms', 10, ...
                'rftime_ms',  1, ...
                'period_ms',  45,...%80, 45 for thresholds, ... %65 before
                'XstartPlot_ms',0, ...
                'XendPlot_ms',31, ...
                'CAPlength_ms',31), ...       
         'slow', struct( ...
         ...
         'CalibBelow90', 0, ...
         'CAPmem_reps',  20, ...
         'threshV', 0.6, ... %for artifact rejection KH 2011 Jun 08
         'threshV2', 3.6,... % for artifact rejection channel 2 JMR nov 21
         'clickYes', 0, ... % added by KH 06Jan2012
      ...
      RunLevels_params = struct( ... 
         'nPairs', 300,...%300,... % changed from 1000
         'stepdB', 10, ... 
... %        'attenMask', [2 1 0 -1 -2 -3], ...
     ...
     AutoLevel_params = struct ( ...  %%added by SP 
         ...
         'nPairs', 300, ...%1000, ... 400 for thresholds
         'stepdB', 10, ... %20, 10 for thresholds
         'attenMask', [], ...
         'decimateFact', 1, ...
         'saveRepsYes', 0, ... %added by KH 6
         'bMultiOutputFiles', 1, ...
         'maxdBSPLtoRUN', 80, ... %80, 50 for thresholds JMR
         'ReRunFlag', 0, ...
         'dB5Flag', 0, ...
         'ReRun_dBSPL', [], ...
