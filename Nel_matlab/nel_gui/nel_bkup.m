function varargout = nel_bkup(varargin)
% NEL_BKUP Application M-file for nel_bkup.fig
%    FIG = NEL_BKUP launch nel_bkup GUI.
%    NEL_BKUP('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 20-May-2002 15:32:55
...
% NelData.General.Pulse.nPulses = 4;   % ge debug: remove after first call.
% NelData.General.Pulse.interPulse = 50;  % ge debug: remove after first call.
