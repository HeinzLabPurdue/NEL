...
switch (host)
case {'north-chamber'}
	root_dir = 'd:\Users\GE\';  % added by GE 04Mar2004.
	data_dir = 'd:\ExpData\'; % added by GE 04Mar2004.
case {'south-chamber'}
	root_dir = 'c:\Users\GE\Matlab_ABR';  % added by GE 04Mar2004.
	data_dir = 'c:\ExpData\'; % added by GE 04Mar2004.
end   
...
if nargin < 1
    ...
    if ~exist('Stimuli')|~isfield(Stimuli, 'cal_pic')
...
%     FIG.push.edit    = uicontrol(FIG.handle,'style','edit','Units','normalized','position',[.32 .08 .1 .04],'string',[],'FontSize',12);								
    FIG.push.edit    = uicontrol(FIG.handle,'style','edit', 'callback', 'abr_analysis(''edit'');', ...
...
%    text(.2,.65,'Directory:','fontsize',10,'color','k','horizontalalignment','left','VerticalAlignment','middle');
    ...
    FIG.a2.axesR = axes('Position',[left+width bottom 0.001 height]); % for labelling right axis
	set(gca, 'FontSize', 12);
	set(gca, 'XTickMode', 'manual');
	set(gca, 'YAxisLocation', 'right');
	set(gca, 'YTickMode', 'manual');

    FIG.ax2.axes = axes('Position',[left bottom width height]);  % modified by GE 14Apr2004
    ...
    FIG.ax2.rect = rectangle;  % added by GE 04Mar2004.
    FIG.ax2.rect2 = rectangle;  % added by GE 14Apr2004.
...
elseif strcmp(command_str,'process')
    [error] = thresh_calc;
    set(FIG.handle, 'CurrentObject', FIG.push.edit);
