...
%    FFR_Gating.duration_ms = str2num(cell2str(answer(4)));
   ...
   copyfile(Stimuli.filename,'C:\NEL_debug\Nel_matlab\FFR\Signals\tone_org.wav','f');
   copyfile(fn_inv,'C:\NEL_debug\Nel_matlab\FFR\Signals\tone_inv.wav','f');
...
elseif strcmp(command_str,'wavfile')
   ...
   copyfile(Stimuli.filename,'C:\NEL_debug\Nel_matlab\FFR\Signals\tone_org.wav','f');
   copyfile(Stimuli.filename,'C:\NEL_debug\Nel_matlab\FFR\Signals\tone_inv.wav','f');
