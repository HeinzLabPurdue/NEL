...
global PROG FIG Stimuli FFR_Gating root_dir prog_dir NelData devices_names_vector Display interface_type misc
global data_dir 
...
%    FIG   = struct('handle',[],'edit',[],'push',push,'radio',radio,'fsldr',fsldr,'asldr',asldr,'NewStim',0,'ax',ax,'popup',popup, 'statText', statText);  % modified by GE 17Jan2003.
    ...
    FFR_ins;   %should already be populated by CAP_ins  %MW 11-21-2016 need to make sure to handle all globals before eliminating this line
...
%    FFR_Gating.duration_ms = str2num(cell2str(answer(4)));
   ...
   copyfile(Stimuli.filename, [NelData.General.RootDir 'Nel_matlab\FFR\Signals\tone_org.wav'],'f'); %All instances of NEL_debug replaced with NEL2, DA 11/3/16
