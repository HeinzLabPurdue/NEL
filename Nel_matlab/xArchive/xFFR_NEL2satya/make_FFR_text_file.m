...
[x, aux_fname, stimuli_fname]=make_FFR_Se_text_file_subfunc1 ...
    (misc, Stimuli, PROG, NelData, comment, RunLevels_params, FFR_Gating, Display);
...
make_FFR_Se_text_file_subfunc2(fname, x, aux_fname, NelData);