...
%              The device order is:  L6  L3  R6  R3  KH-oscillator RP1-ch1 RP1-ch2 RP2-ch1 RP2-ch2
...
global hardwired_devices

min_i = -1;
min_pre_attn = Inf;
if (all(isnan(attns)))
   nelwarn('find_mix_settings: Are you sure you don''t want to hear anything?');
end
attns(find(isnan(attns) & repmat(hardwired_devices',1,2))) = 120;
