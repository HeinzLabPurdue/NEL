...
switch interface_type
    case 'FFRwav'
        ...
        Stimuli = struct( ...
            ...
            'fast', struct( ...
            ... %zz 17jan12
            'duration_ms', 4000, ... % stimulus dur 
            'rftime_ms',  10, ...
            'period_ms',  5003, ...   % make irregular to avoid exact repeats (avoid 60 Hz)
            'XstartPlot_ms',0, ...
            'XendPlot_ms',5003, ... % 2000 for pilot, 1800 for short 
            'FFRlength_ms',4000), ... % 2000 for pilot, 1800 for short 
            ...
            ...
            'slow', struct( ...
            ...% ZZ 18nov11
