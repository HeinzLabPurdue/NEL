function [tmplt,DAL,stimulus_vals,units,errstr] = BBNrlv_quick_template(fieldname,stimulus_vals,units)
...
%% Inloop Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File              = { fullfile(signals_dir,'VM','BBN_SCCXCC','BBN_A.wav') '' [] 1 };
IO_def.Inloop.Low_Attenuation   = { 1             'dB'    [0    120]      };
IO_def.Inloop.High_Attenuation  = { 60           'dB'    [0    120]      };
