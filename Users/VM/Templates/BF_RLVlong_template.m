...
if (exist('stimulus_vals','var') == 1)
   ...
   DAL.endLinePlotParams                  = default_plot_rate_params(DAL.Gating.Period/1000, DAL.Gating.Duration/1000);  % GE 04Nov2003.
...
p = DAL.Inloop.params;
str{1} = sprintf('BF RLV %d Repetitions', p.repetitions);
...
%% Gating Section 
%%%%%%%%%%%%%%%%%%%%
% Changed from 200/500/2 to 300/1000/10 Dec 15 20167 Mheinz
...
IO_def.Gating.Rise_fall_time   = {10 'ms'   [0  1000]}; 
