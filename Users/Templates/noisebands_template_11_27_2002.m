...
if (exist('stimulus_vals','var') == 1)
   Inloop.Name                            = 'DALinloop_noisebands';
...
if (isequal(fieldname,'Inloop'))
   ...
   if fmax>DAL.Inloop.params.sr/1e3/2
      errstr='HBW too large or end frequency too high! => aliasing';
   end
...
IO_def.Inloop.Frequency_Start     =  {'current_unit_bf/4'        'kHz'      [0.04  50]   0  0}; 
IO_def.Inloop.Frequency_End       =  {'current_unit_bf*4'        'kHz'      [0.04  50]   0  0}; 
...
IO_def.Inloop.Attenuation         =  {'current_unit_thresh-40'        'dB'      [0 120]   0  0}; 
IO_def.Inloop.Band_Height          =  {40        'dB'      [0 120]   0  0}; 
