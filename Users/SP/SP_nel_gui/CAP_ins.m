   ...
   case 'ABR'
		...
		Stimuli = struct( ...
         ...
         'fast', struct( ...
                'duration_ms', 5, ...
                'rftime_ms',  0.5, ...
                'period_ms',  500, ... %HG changed 10/9/20 - was 51,43 - HERE!
                'XstartPlot_ms',0, ...
                'XendPlot_ms',31, ...
                'CAPlength_ms',31), ...
         'slow', struct( ...
      ...
      RunLevels_params = struct( ... 
         'nPairs', 500,... %HG changed from 5 -- should be 500
         'stepdB', 10, ... 
... %        'attenMask', [2 1 0 -1 -2 -3], ...
     ...
     AutoLevel_params = struct ( ...  %%added by SP 
         ...
         'stepdB', 10, ... 
         'attenMask', [], ...
         'decimateFact', 4, ... % 4 because using 50k for both stim&data circuits, but data is bandpassed below 3 kHz, so save at fs=12kHz. 
         'saveRepsYes', 0, ... %added by KH 6
         'bMultiOutputFiles', 1, ...
         'maxdBSPLtoRUN', 80, ...
         'ReRunFlag', 0, ...
