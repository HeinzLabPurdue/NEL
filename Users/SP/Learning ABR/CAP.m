...
%     popup = cell2struct(cell(1,1),{'spike_channel'},2);   % added by GE 17Jan2003.
    ...
    FIG   = struct('handle',[],'edit',[],'push',push,'radio',radio,'checkbox',checkbox,...
        'statText', statText, 'fsldr',fsldr,'asldr',asldr,'NewStim',0,'ax',ax);
    
    CAP_ins;
    
    FIG.handle = figure('NumberTitle','off','Name','CAP Interface','Units','normalized','position',...
        [0.045  0.013  0.9502  0.7474],'Visible','off','MenuBar','none','Tag','CAP_Main_Fig');
