function [tmplt,DAL,stimulus_vals,units,errstr] = T1_template(fieldname,stimulus_vals,units)
%
...
if (exist('stimulus_vals','var') == 1)
   ...
   if((stimulus_vals.Inloop.Frequency ~= 1)|(length(DAL.Inloop.params.main.attens) == 1))
...
%% Inloop Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.Frequency         =  { 1                  'kHz'      [0.04  45]  1}; 
