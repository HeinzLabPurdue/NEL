function [tmplt,DAL,stimulus_vals,units,errstr] = FWCEFS_template(fieldname,stimulus_vals,units)
%
% Template for T. Ji Exps, "Five Women ..." w/CEFS sentence: fivewoCEFS.wav 
%
% MH: 7/31/02
...
if (exist('stimulus_vals','var') == 1)    
   ...
   if((~isequal(fullfile('',[Xfile Xext]),'fivewoCEFS.wav'))| ...
...
%% Inloop Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File              = { fullfile(signals_dir,'fivewoCEFS.wav') '' [] 1 };
