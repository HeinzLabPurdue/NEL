function varargout = DALinloop_wavfiles_compressed_ABIILD(varargin)
%
...
% AF 9/22/01
% SMC 4/1/04: DALinloop_wavfiles_compressed.m plots against attenuation if it changes, and file number if not.
%             I want the ABI/ILD files to plot against presentation, so I created this inloop function.
   ...
   if (nstim > 1)
      ...
      for ii = 1:specific.repetitions
         for jj = 1:nstim
            ...
            var_labels{counter} = ['ABI ' int2str(abicase) ', ILD ' int2str(ildcase) ':']; 
