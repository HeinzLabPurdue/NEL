function [tmplt,DAL,stimulus_vals,units,errstr] = schase_template(fieldname,stimulus_vals,units)
%
...
if (exist('stimulus_vals','var') == 1)
   ...
   List_File = [signals_dir 'Lists\schase\ild.m' ];
