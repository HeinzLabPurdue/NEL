function [tmplt,DAL,stimulus_vals,units,errstr] = SAM32_reBF_pos_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'SAM32_pos_rlf';
...
ModFreq= 32;
fName= create_SAM_reBF(OutFolder, NelData.File_Manager.unit.BF*1e3, ModFreq, 'pos');
