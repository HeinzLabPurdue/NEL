function [tmplt,DAL,stimulus_vals,units,errstr] = Stat_EH_neg_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'Stat_EH_neg_rlf';
...
%% Inloop Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File           = { fullfile(signals_dir,'MH','Env_Level_Coding','Stat_EH_vowel_neg.wav') '' [] 1 };
