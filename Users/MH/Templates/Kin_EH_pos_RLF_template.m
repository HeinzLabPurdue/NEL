function [tmplt,DAL,stimulus_vals,units,errstr] = Kin_EH_pos_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'Kin_EH_pos_rlf';
...
%% Inloop Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File           = { fullfile(signals_dir,'MH','Env_Level_Coding','Kin_EH_vowel_pos.wav') '' [] 1 };
