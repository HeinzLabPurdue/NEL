function [tmplt,DAL,stimulus_vals,units,errstr] = Danish_neg_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'Danish_neg_rlf';
...
%% Inloop Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File           = { fullfile(signals_dir,'MH','Env_Level_Coding','FLN_Stim_S_N.wav') '' [] 1 };
