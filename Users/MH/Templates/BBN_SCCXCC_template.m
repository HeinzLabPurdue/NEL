function [tmplt,DAL,stimulus_vals,units,errstr] = BBN_SCCXCC_template(fieldname,stimulus_vals,units)
...
% END: removed by GE 07oct2003.      
   ...
   DAL.short_description   = 'BBN_SX'; % added by GE 26Jul2002
...
% IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\BBN_SCCXCC\\BBN_SCCXCC_AB4.m', signals_dir)  };
% IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\BBN_SCCXCC\\BBN_SCCXCC_A2.m', signals_dir)  };
IO_def.Inloop.List_File             = { {['uigetfile(''' signals_dir 'Lists\MH\BBN_SCCXCC\*.m'')']} };
