function [tmplt,DAL,stimulus_vals,units,errstr] = SNRenv_FLN_template(fieldname,stimulus_vals,units)
...
% END: removed by GE 07oct2003.      
   ...
   %load file
   [x,~]=audioread([NelData.General.RootDir 'Signals\MH\SNRenv\stimSetStationary\Stim_S_P.wav']); 
   ...
   DAL.short_description   = 'SNRenvFLN'; % added by GE 26Jul2002
...
IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_14stim_FLN.m', signals_dir)  };
% IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_18stim_FLN.m', signals_dir)  };
