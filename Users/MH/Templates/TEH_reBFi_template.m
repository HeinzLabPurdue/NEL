...
%    %    Levels_dBSPL=stimulus_vals.Inloop.Max_Level;  % ONE LEVEL
   %  30Jun2005: M. Heinz: Min_level (LEH from EHrlv) is a param, but Levels_list re min is HARD CODED HERE
   
   Levels_dBSPL=stimulus_vals.Inloop.Min_Level+[0 15 30];  % THREE LEVELS
   %    Levels_dBSPL=stimulus_vals.Inloop.Min_Level;  % ONE LEVEL
...
IO_def.Inloop.Min_Level  =  {50 'dB SPL'       [-50    150]   0  0}; 
