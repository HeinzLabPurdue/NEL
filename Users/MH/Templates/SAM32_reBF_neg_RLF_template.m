function [tmplt,DAL,stimulus_vals,units,errstr] = SAM32_reBF_neg_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'SAM32_neg_rlf';
