function [tmplt,DAL,stimulus_vals,units,errstr] = BBNlong2_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'BBNlong'; % added by GE 26Jul2002
...
IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\BBNlong\\BBNlong_stim.m', signals_dir)  };
...
%% Gating Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Gating.Duration             = {2200       'ms'    [20 4000]};
