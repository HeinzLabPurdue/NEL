function [tmplt,DAL,stimulus_vals,units,errstr] = BBNrlv_quick_template2(fieldname,stimulus_vals,units)
...
%% Inloop Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File              = { fullfile(signals_dir,'KH','BBNlong','BBN1_P.wav') '' [] 1 };
