...
if (exist('stimulus_vals','var') == 1)
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%
   %  032805:  OctShifts=[-1.0 -.75 -.50 -.25 -.15 -.05 0 .05 .15 .25 .50 .75 1.0];
   OctShifts=[-.75 -.50 -.25 -.15 -.05 0 .05 .15 .25 .50 .75];  % 041805

   
   OctShifts=[-.75 -.50 -.25 -.15 -.05 0 .05 .15 .25];  % 041805
   ...
   Levels_dBSPL=stimulus_vals.Inloop.Max_Level+[-50 -40 -30 -20 -10 0];  % SIX LEVELS
   %%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%%%%%%%%%%%%%%%%%%%%%%%%%%
...
IO_def.Inloop.Max_Level  =  {80 'dB SPL'       [-50    150]   0  0}; 
