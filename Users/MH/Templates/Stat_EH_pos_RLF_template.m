function [tmplt,DAL,stimulus_vals,units,errstr] = Stat_EH_pos_RLF_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'Stat_EH_pos_rlf';
...
%% Inloop Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File           = { fullfile(signals_dir,'MH','Env_Level_Coding','Stat_EH_vowel_pos.wav') '' [] 1 };
IO_def.Inloop.CalibPicNum    =  {calib_picNum   ''       [0 6000]};
IO_def.Inloop.Low_dBSPL      = { 10             'dB'    [0    120]      };
IO_def.Inloop.High_dBSPL     = { 80           'dB'    [0    120]      };
