function [tmplt,DAL,stimulus_vals,units,errstr] = SNRenv_min10_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    %    end
    %load file
    %    [x,fs]=audioread('C:\NEL\Signals\MH\SNRenv\SNR_min10\FLN_Stim_S_P.wav');
    ...
    audio_fName=[NelData.General.RootDir 'Signals\MH\SNRenv\SNR_min10\FLN_Stim_S_P.wav'];
    cdd;
    ...
    DAL.short_description   = 'SNRenv_min10'; % added by GE 26Jul2002
...
IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_min10.m', signals_dir)  };
