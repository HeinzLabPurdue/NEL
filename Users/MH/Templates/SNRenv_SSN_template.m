function [tmplt,DAL,stimulus_vals,units,errstr] = SNRenv_SSN_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    ...
    DAL.short_description   = 'SNRenvSSN'; % added by GE 26Jul2002
...
IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_14stim_SSN.m', signals_dir)  };
