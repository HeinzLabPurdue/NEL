function [tmplt,DAL,stimulus_vals,units,errstr] = SNRenv_template(fieldname,stimulus_vals,units)
...
if (exist('stimulus_vals','var') == 1)
    if (exist(stimulus_vals.Inloop.List_File,'file') ~= 0)
        [Llist,~] = read_rotate_list_file(stimulus_vals.Inloop.List_File);
    ...
    DAL.short_description   = 'SNRenv'; % added by GE 26Jul2002
...
% IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_14stim.m', signals_dir)  };
% IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_18stim.m', signals_dir)  };
IO_def.Inloop.List_File             = {sprintf('%sLists\\MH\\SNRenv\\SNRenv_22stim.m', signals_dir)  };
...
IO_def.Inloop.UpdateRate        = { 22050                  'Hz'      [1    NI6052UsableRate_Hz(Inf)]      };

%%%%%%%%%%%%%%%%%%%%
%% Gating Section
%%%%%%%%%%%%%%%%%%%%
IO_def.Gating.Duration             = {3346       'ms'    [20 4000]};
IO_def.Gating.Period               = {4000    'ms'   [50 5000]};
