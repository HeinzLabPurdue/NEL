...
str{1} = sprintf('%s @%.3f kHz+%.2f:%.2f:%.2foct', str{1},stimulus_vals.Inloop.BaseFrequency,stimulus_vals.Inloop.OctShifts_low,stimulus_vals.Inloop.OctShifts_step,stimulus_vals.Inloop.OctShifts_high);
