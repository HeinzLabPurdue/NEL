function [tmplt,DAL,stimulus_vals,units,errstr] = FN_template(fieldname,stimulus_vals,units)
%
% Template for Recruitment Stimulus FN: romnoise97k.wav, rate-level, 210-ms (TOTAL) duration 
%
% MH 12/17/01
...
if (exist('stimulus_vals','var') == 1)  
   ...
   if((~isequal(fullfile('',[Xfile Xext]),'romnoise97k.wav'))| ...
...
%% Inloop Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File              = { fullfile(signals_dir,'romnoise97k.wav') '' [] 1 };
...
%% Gating Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Gating.Duration             = {210       'ms'    [20 2000] 1};
