function [tmplt,DAL,stimulus_vals,units,errstr] = PSTasync_template(fieldname,stimulus_vals,units)
%
...
%   Inloop.Name                               = 'DALinloop_general_TN_delay';  % modified by GE (07Jan2003)  %Removed MH(12Nov2003)
   Inloop.Name                               = 'DALinloop_general_TN_async';
