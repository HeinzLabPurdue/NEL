function [tmplt,DAL,stimulus_vals,units,errstr] = SACrlv_template(fieldname,stimulus_vals,units)
...
%% Inloop Section 
%%%%%%%%%%%%%%%%%%%%
IO_def.Inloop.File              = { fullfile(signals_dir,'MH','EHvowels','baseNOISE.wav') '' [] 1 };
IO_def.Inloop.Low_Attenuation   = { 10             'dB'    [0    120]      };
IO_def.Inloop.High_Attenuation  = { 70           'dB'    [0    120]      };
IO_def.Inloop.dBstep_Atten  = { 20           'dB'    [1    120]      };
