function [tmplt,DAL,stimulus_vals,units,errstr] = TX_template(fieldname,stimulus_vals,units)
%
% Template for Recruitment Stimulus TX: Arbitrary-frequency tone, rate-level, 200-ms duration
%
% MH 11/01/02
...
IO_def.Inloop.Frequency         =  { []                  'kHz'      [0.04  45]}; 
