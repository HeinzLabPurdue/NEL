function [tmplt,DAL,stimulus_vals,units,errstr] = T2_template(fieldname,stimulus_vals,units)
%
% Template for Recruitment Stimulus T2: 2-kHz tone, rate-level, 200-ms duration
%
% MH 12/17/01
