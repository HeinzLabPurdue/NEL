function [tmplt,DAL,stimulus_vals,units,errstr] = B1_template(fieldname,stimulus_vals,units)
%
...
if (exist('stimulus_vals','var') == 1)
   ...
   if((stimulus_vals.Inloop.Frequency ~= 1)| ...
