...
if (exist('stimulus_vals','var') == 1)
   ...
   BASELINE_TargetFreq_Hz=stimulus_vals.Inloop.BaseFrequency*1000;
      BASELINE_F0_Hz=75;
%    BASELINE_F0_Hz=stimulus_vals.Inloop.BaseF0;
   BASELINE_Feature='F2';
   ...
   % Creat OctShift vector
   OctShifts=stimulus_vals.Inloop.OctShifts_low:stimulus_vals.Inloop.OctShifts_step:stimulus_vals.Inloop.OctShifts_high;
   ...
   Inloop.params.Condition.OctShifts_low                  = stimulus_vals.Inloop.OctShifts_low;
   Inloop.params.Condition.OctShifts_high                  = stimulus_vals.Inloop.OctShifts_high;
   Inloop.params.Condition.OctShifts_step                  = stimulus_vals.Inloop.OctShifts_step;
...
str{1} = sprintf('ROT %d reps:', p.repetitions);
...
str{1} = sprintf('%s Features: %s,', str{1}, 'F1|T1');
str{1} = sprintf('%s  @ %.f kHz + %.2f:%.2f:%.2f octs)', str{1},stimulus_vals.Inloop.BaseFrequency,stimulus_vals.Inloop.OctShifts_low,stimulus_vals.Inloop.OctShifts_step,stimulus_vals.Inloop.OctShifts_high);
...
IO_def.Inloop.OctShifts_low        =  {0 'octaves'};
IO_def.Inloop.OctShifts_high        =  {.05 'octaves'};
