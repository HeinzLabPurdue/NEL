function [vowel,Fs,filename,dBreTONE,NEWforms_Hz]=synth_BASELINE_eh(TargetFreq_Hz,NEWF0_Hz,TargetFeature,Fix2Harms,mode)
% FIle: synth_BASELINE_eh.m
%
...
if Fix2Harms
   ...
   for ind=1:NUMforms
      if rem(NEWforms_Hz(ind),NEWF0_Hz)
         disp(sprintf('NEWform %d not at harmonic, ... adjusting',ind))
